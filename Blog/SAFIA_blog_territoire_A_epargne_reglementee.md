# Territoire A — Épargne réglementée

7 articles · Auteur : Maxime Bouché, CIF · Rédigés le 14 septembre 2026

**Chiffres de référence utilisés dans tout le territoire**, vérifiés le 14 septembre 2026 : livret A et LDDS à 1,70 % depuis le 1er août 2026 (arrêté du 29 juillet 2026, publié au Journal officiel le 31 juillet) ; LEP à 2,50 %, maintenu jusqu'au 31 janvier 2027 ; plafonds de versement de 22 950 €, 12 000 € et 10 000 € ; CEL à 1,25 % brut ; PEL à 2 % pour les plans ouverts en 2026.

Chaque article se termine par le bloc auteur et l'avertissement réglementaire, repris à l'identique et donc écrit une seule fois ici :
...
* Les intérêts sont **exonérés d'impôt sur le revenu et de prélèvements sociaux**, ce qui est devenu rare depuis la hausse de 2026 sur les autres placements.
* Les intérêts se calculent **par quinzaine** : la date de ton versement change le résultat.
...
* Au-delà, il n'y a plus de solution sans arbitrage : il faut accepter soit **un blocage**, soit **un risque de perte en capital**.
* La bonne question n'est pas « quel placement rapporte le plus » mais **« dans combien de temps ai-je besoin de cet argent »**.
...
* Trois différences réelles : **le plafond** (22 950 € contre 12 000 €), **l'âge d'ouverture** et **l'usage des fonds collectés**.
* Ce ne sont pas des concurrents : **ils se cumulent**, et la seule stratégie sensée est d'avoir les deux.
...
* L'erreur d'allocation la plus répandue en France n'est pas d'épargner trop peu, mais de **laisser trop longtemps trop d'argent sur des livrets**.
* Cette réserve doit rester **liquide et sans risque**, même si elle rapporte peu. C'est sa fonction, pas son défaut.
...
* Le gouvernement peut **s'écarter de la formule** : c'est ce qu'il fait pour le LEP, pas pour le livret A en août 2026.
* Comprendre la formule permet d'**anticiper** la révision suivante à quelques dixièmes près.
...
Page **Particuliers** · articles **A1** (livret A) et **A4** (LEP).
