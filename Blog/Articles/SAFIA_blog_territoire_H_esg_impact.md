# Territoire H — ESG et investissement à impact

5 articles · Auteur : Maxime Bouché, CIF · Rédigés le 14 septembre 2026

**Rôle de ce territoire.** Le volume de recherche est faible et assumé : « investissement responsable » pèse environ 300 requêtes mensuelles en France, « ISR » une trentaine. Ces articles ne sont pas là pour faire du trafic mais pour **qualifier** : ils s'adressent précisément au profil d'early adopter que l'ADN Investisseur cherche à capter, et ils constituent la passerelle éditoriale la plus directe vers cette page.

**Contexte réglementaire vérifié le 14 septembre 2026** : règlement SFDR (UE) 2019/2088, applicable depuis le 10 mars 2021, classification en articles 6, 8 et 9, **auto-déclarée** par la société de gestion ; réforme dite SFDR 2.0 proposée par la Commission européenne en novembre 2025, prévoyant de remplacer ces articles par trois catégories (« Sustainable », « Transition », « ESG Basics ») assorties de seuils d'allocation minimale, avec une entrée en application attendue autour de 2027-2028 ; le Parlement européen a proposé en mai 2026 des exigences plus strictes que la proposition initiale ; label ISR réformé en mars 2024, avec exclusion des énergies fossiles et déréférencement d'environ 330 fonds, l'offre labellisée passant d'environ 1 340 à 970 fonds ; loi Industrie Verte applicable au 1er janvier 2026, imposant une part de supports labellisés dans les mandats de gestion pilotée en assurance-vie.
...
> Cet article a une vocation informative et pédagogique. Il ne constitue pas un conseil en investissement personnalisé au sens de l'article L. 541-1 du Code monétaire et financier, et ne recommande aucun produit en particulier. Tout investissement en unités de compte comporte un risque de perte en capital. Le cadre réglementaire décrit est en cours d'évolution.
...
- Aucune de ces approches ne garantit une performance supérieure ou inférieure : les études divergent, et l'honnêteté consiste à le dire.
- Le décalage entre l'intention et le portefeuille réel est la norme, pas l'exception.
...
- **Finansol** ne mesure pas la performance environnementale mais le caractère **solidaire** du financement.
- Un label est une **vérification indépendante**, contrairement à la classification SFDR, qui est auto-déclarée.
...
Page **ADN Investisseur** · articles **H3** (SFDR) et **H5** (greenwashing).
...
- La classification est **auto-déclarée** par la société de gestion, sans audit externe systématique.
- Une réforme, dite SFDR 2.0, doit remplacer ces catégories par trois nouvelles, avec des **seuils chiffrés**, à l'horizon 2027-2028.
...
- Une note ESG mesure le plus souvent **le risque financier lié aux enjeux de durabilité**, pas l'impact de l'entreprise sur le monde.
- Une note n'est donc pas une vérité : c'est **l'opinion d'un acteur, selon sa méthode**.
...
2. Ouvrir l'annexe précontractuelle SFDR et noter la part minimale d'investissements durables.
3. Vérifier la présence d'un label indépendant, ISR ou Greenfin.
