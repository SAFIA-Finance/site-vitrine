# Territoire G — Professionnels, CGP et CIF (partie 2/2)

Articles G7 à G12 · Auteur : Maxime Bouché, CIF · Rédigés le 14 septembre 2026 · **Vouvoiement**
...
Page **Conseillers** · articles **G10** (LCB-FT) et **G4** (lettre de mission).
...
Il consiste à identifier et évaluer les risques auxquels votre activité vous expose, au regard de votre clientèle, des produits que vous distribuez, des canaux de distribution utilisés et des zones géographiques concernées.

De cette classification découle le niveau de vigilance appliqué à chaque relation. Une vigilance allégée sur un dossier n'est défendable que si la classification la justifie.
...
**En continu.** Actualisation des informations, examen de la cohérence des opérations avec la connaissance que vous avez du client, et **examen renforcé** des opérations particulièrement complexes, d'un montant inhabituellement élevé ou sans justification économique apparente. Cet examen renforcé donne lieu à un écrit conservé.

**Modulation.** La vigilance est renforcée notamment en cas de relation à distance sans mesure compensatoire, de personne politiquement exposée, ou de lien avec un pays tiers à haut risque.
...
Le critère est le **soupçon**, pas la preuve. Attendre une certitude est une erreur d'appréciation de la norme.

La déclaration est **confidentielle** : il est interdit d'informer le client ou un tiers de son existence.

Le déclarant de bonne foi bénéficie d'une **exonération de responsabilité** professionnelle, civile et pénale au titre de la déclaration.
...
Tenez à jour vos procédures écrites, cohérentes avec votre classification.
...
Un prospect qui prend contact est dans une fenêtre d'intention étroite. Chaque semaine qui passe avant un échange de fond réduit la probabilité de conclusion et augmente celle qu'il consulte ailleurs.

Or ce délai est rarement mesuré. Il se compose de temps morts : attente d'un retour de pièces, relances, rendez-vous consacré à de la saisie plutôt qu'à de l'analyse.

Mesurez-le sur vos dix derniers dossiers. Le résultat surprend souvent.

### Les cinq étapes

**1. La qualification.** Un formulaire court, quelques questions sur la situation et l'attente, qui permet de savoir si le dossier relève de votre offre et de préparer l'échange. Cinq à sept questions suffisent ; au-delà, le taux d'abandon grimpe.

**2. La prise de rendez-vous.** Un lien de réservation en ligne supprime la séquence d'allers-retours par courriel, qui coûte à elle seule plusieurs jours.

**3. La remise des documents d'information.** Document d'entrée en relation, information sur les modes de rémunération et les liens avec les producteurs. Ces documents doivent être remis **avant** la prestation ; les transmettre de façon traçable au moment de la confirmation du rendez-vous règle l'obligation et fait gagner du temps en séance.
...
**Automatisable sans réserve** : la prise de rendez-vous, la remise tracée des documents d'information, la collecte des pièces, les relances, la signature électronique.

**Automatisable partiellement** : le recueil d'informations. La saisie peut être faite par le client, mais l'**examen de cohérence** relève de vous. Un client qui déclare une tolérance élevée au risque et une capacité de perte nulle a produit deux réponses contradictoires : c'est à vous de le relever et de le traiter en séance.

**Non automatisable** : l'appréciation de l'adéquation, la motivation de la recommandation, la vérification de l'identité selon les modalités requises, et l'analyse des situations atypiques.

### La signature électronique

Elle est admise, mais tous les procédés ne se valent pas. Le règlement européen eIDAS distingue plusieurs niveaux, dont la valeur probante diffère. Pour des documents engageants, un niveau avancé au minimum est recommandé, avec conservation de l'horodatage et du dossier de preuve.

Vérifiez ce que votre prestataire conserve réellement et pendant combien de temps : en cas de contestation, c'est le dossier de preuve qui compte, pas le fichier PDF signé.

### Le point de vigilance LCB-FT

L'entrée en relation **à distance** appelle une vigilance appropriée. Les modalités de vérification de l'identité et les mesures compensatoires doivent être définies dans vos procédures et cohérentes avec votre classification des risques.

Un parcours entièrement digital n'est pas interdit ; un parcours digital sans dispositif de vérification documenté l'est en pratique, parce qu'il n'est pas justifiable.

### L'effet mesurable

**Exemple.** Un cabinet dont le délai moyen entre premier contact et premier rendez-vous utile est de 24 jours : trois jours pour caler la date, douze jours d'attente, puis un premier rendez-vous consacré pour moitié à la collecte, suivi d'un second rendez-vous neuf jours plus tard pour aborder le fond.
