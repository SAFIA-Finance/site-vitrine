# Territoire E — Comparaison et décision

5 articles · Auteur : Maxime Bouché, CIF · Rédigés le 14 septembre 2026

**Rôle de ce territoire.** Ce sont les articles dont les lecteurs sont les plus proches d'une décision. Ils portent une contrainte juridique spécifique : la publicité comparative n'est licite que si elle porte sur des **caractéristiques objectives, pertinentes et vérifiables**, sans dénigrement (articles L. 122-1 et suivants du Code de la consommation). Aucun de ces articles ne nomme un concurrent pour le dévaloriser ; les comparaisons portent sur des **catégories de services**, pas sur des marques.
...
> Cet article a une vocation informative et pédagogique. Il ne constitue pas un conseil en investissement personnalisé au sens de l'article L. 541-1 du Code monétaire et financier. Les hypothèses de rendement utilisées sont des hypothèses de calcul, sans valeur d'engagement. Tout investissement comporte un risque de perte en capital.
...
- Son intérêt tient à la discipline et au coût, généralement inférieur à la gestion pilotée bancaire classique.
- Ce n'est **ni un assistant, ni un agrégateur, ni un conseiller** : trois catégories que le vocabulaire courant confond.
...
Page **Assistant IA** · articles **E2** (gestion pilotée ou libre) et **E4** (effet des frais).
...
- L'écart de performance entre les deux n'est **pas prévisible** ; l'écart de frais, lui, est connu d'avance.
- Le vrai critère est comportemental : **que feras-tu le jour où ton portefeuille perdra 20 % ?**
...
*Gestion libre, 0,8 % de frais totaux.* Capital final : environ **136 800 €**.
*Gestion pilotée, 1,7 % de frais totaux.* Capital final : environ **115 300 €**.
...
Quelle est l'**allocation cible** de mon profil, précisément ?
À quelle **fréquence** les arbitrages ont-ils lieu, et sur quel critère ?
Puis-je **sortir du mandat** à tout moment, et à quel coût ?
Quelle **performance** ce profil a-t-il servi sur cinq ans, nette de frais, et sur quel périmètre ?
...
Page **Assistant IA** · articles **E1** (robo-advisor) et **E4** (effet des frais).
...
- Sur vingt ans, un écart de un point de frais absorbe couramment **15 à 20 %** du capital final.
- Le coût réel se calcule en **additionnant** frais du contrat et frais internes des supports.

### Pourquoi un point paraît petit et ne l'est pas
...
Page **Tarifs** · articles **B7** (frais d'assurance-vie) et **E2** (gestion pilotée ou libre).
...
- Le seuil d'accès pratique au conseil patrimonial personnalisé se situe souvent autour de **250 000 € d'actifs**, sans que ce soit une règle écrite.
- En dessous, l'offre existe mais se réduit à un conseil ponctuel ou à des services standardisés.
...
Comment êtes-vous rémunéré, précisément, sur cette prestation ?
Avez-vous des liens capitalistiques ou commerciaux avec des producteurs ?
Que comprend exactement le suivi annuel ?
Quel est le total des frais que je supporterai, toutes couches confondues ?
Puis-je recevoir votre document d'entrée en relation et une lettre de mission ?
