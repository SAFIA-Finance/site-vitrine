# Territoire B — Assurance-vie et fiscalité

8 articles · Auteur : Maxime Bouché, CIF · Rédigés le 14 septembre 2026

**Chiffres de référence utilisés dans tout le territoire**, vérifiés le 14 septembre 2026 : abattement annuel de 4 600 € (personne seule) et 9 200 € (couple marié ou pacsé) sur les gains après huit ans ; prélèvement forfaitaire de 7,5 % sous 150 000 € de primes versées, 12,8 % au-delà ; prélèvements sociaux **maintenus à 17,2 %** sur l'assurance-vie alors qu'ils passent à 18,6 % sur le PEA, le compte-titres et l'épargne salariale depuis le 1er janvier 2026 (LFSS 2026) ; abattement successoral de 152 500 € par bénéficiaire pour les primes versées avant 70 ans (article 990 I du CGI), puis 20 % jusqu'à 700 000 € et 31,25 % au-delà ; abattement global de 30 500 € pour les primes versées après 70 ans (article 757 B du CGI).

Bloc auteur et avertissement repris à l'identique en fin de chaque article :

> **Maxime Bouché** — conseiller en investissements financiers, immatriculé à l'ORIAS sous le n° 26008152, membre de la CNCGP.
> Cet article a une vocation informative et pédagogique. Il ne constitue pas un conseil en investissement personnalisé au sens de l'article L. 541-1 du Code monétaire et financier. Les taux et seuils cités sont ceux en vigueur à la date de publication et peuvent évoluer. Tout investissement en unités de compte comporte un risque de perte en capital.
...
- Après huit ans : abattement annuel de **4 600 €** ou **9 200 €**, puis 7,5 % d'impôt sous 150 000 € de primes, soit **24,7 %** au total.
- Nouveauté 2026 : l'assurance-vie est **exclue de la hausse des prélèvements sociaux** et reste à 17,2 %, quand le PEA et le compte-titres passent à 18,6 %.
...
*Étape 1, la part de gains.* Gains totaux : 110 000 − 80 000 = 30 000 €.
Part de gains dans le rachat : 20 000 × (30 000 ÷ 110 000) = **5 454 €**.

*Étape 2, l'impôt sur le revenu.* Après l'abattement de 4 600 € : 5 454 − 4 600 = 854 € imposables.
Ses primes versées étant sous 150 000 €, le taux est de 7,5 % : 854 × 7,5 % = **64 €**.
...
Page **Cockpit stratégique** · articles **B3** (rachat partiel) et **B2** (abattement).
...
- Il porte **uniquement sur l'impôt sur le revenu**. Les 17,2 % de prélèvements sociaux restent dus sur la totalité des gains.
- Il s'apprécie **par foyer fiscal**, tous contrats confondus, et **ne se reporte pas** d'une année sur l'autre.
...
*Scénario 1, tout en une fois en décembre 2026.*
Part de gains : 60 000 × 30 % = 18 000 €.
Impôt sur le revenu : (18 000 − 9 200) × 7,5 % = **660 €**.
Prélèvements sociaux : 18 000 × 17,2 % = **3 096 €**.
Total : **3 756 €**.

*Scénario 2, 30 000 € en décembre 2026 et 30 000 € en janvier 2027.*
Part de gains par retrait : 9 000 €, donc entièrement couverte par l'abattement de 9 200 € chaque année.
Impôt sur le revenu : **0 €**.
Prélèvements sociaux : 18 000 × 17,2 % = **3 096 €** au total.
Total : **3 096 €**.
...
Page **Cockpit stratégique** · articles **B1** (fiscalité après 8 ans) et **B3** (rachat partiel).
...
- Le taux dépend de **l'âge du contrat** et du **total des primes versées**.
- Le rachat partiel **ne clôture pas** le contrat et **ne fait pas perdre** l'antériorité fiscale.

### La formule, et pourquoi elle est équitable

L'administration ne considère pas qu'un retrait est prélevé d'abord sur les gains, ni d'abord sur le capital. Elle applique une règle proportionnelle :

> Part de gains imposable = Montant du rachat × (Total des gains ÷ Valeur totale du contrat)

Plus ton contrat est ancien et performant, plus la proportion de gains est élevée, et plus chaque euro retiré contient de matière imposable. C'est mécanique.
...
Ses primes dépassant 150 000 €, une fraction relève du taux de 12,8 %. En retenant par simplification l'application du taux de 12,8 % à la part correspondante, l'impôt sur le revenu se situe autour de **700 à 780 €** selon la répartition retenue par l'assureur.
Prélèvements sociaux : 10 666 × 17,2 % = **1 835 €**.

Ce troisième cas illustre un point important : au-delà de 150 000 € de primes, le calcul cesse d'être évident et l'assureur applique un prorata. Demande-lui une simulation écrite avant de valider un rachat significatif.

### Ce que le rachat partiel ne fait pas

Il ne remet pas le compteur des huit ans à zéro. Ton contrat garde sa date d'ouverture et son antériorité fiscale.

Il ne réduit pas ton abattement des années suivantes : celui-ci se renouvelle intégralement chaque 1er janvier.

Il diminue en revanche le total des primes versées nettes, ce qui peut te faire repasser sous le seuil de 150 000 € si tu l'avais franchi.

### Les trois réflexes avant de racheter

Vérifie **l'âge du contrat**. Si tu es à quelques mois des huit ans, attendre peut diviser l'impôt par deux.
...
Cela dépend de ton contrat : certains appliquent une répartition proportionnelle, d'autres te laissent choisir. C'est une décision d'allocation, distincte de la fiscalité.

**Y a-t-il des frais de rachat ?**
Ils sont rares sur les contrats récents, courants sur les contrats anciens. Vérifie tes conditions générales.
...
- La répartition ne se décide pas sur les performances passées mais sur **l'horizon de placement** et sur **ta capacité réelle à encaisser une baisse**.
- Une allocation n'est pas un choix unique : elle se révise, et le temps qui passe la modifie mécaniquement.

### Ce que chaque poche fait, techniquement
...
*Hypothèse A, 100 % fonds en euros à 2,5 % net par an.*
Capital au terme : environ **77 800 €**.

*Hypothèse B, 60 % unités de compte et 40 % fonds en euros, rendement moyen retenu de 4,5 % net.*
Capital au terme : environ **131 300 €**.
...
Page **ADN Investisseur** · articles **B7** (frais) et **E4** (effet des frais sur vingt ans).
...
- L'abattement se compte **par bénéficiaire**, pas par contrat : désigner plusieurs bénéficiaires le multiplie.
- Le **conjoint marié ou pacsé** est totalement exonéré, quel que soit le montant.
...
Chaque enfant reçoit 310 000 €.
Abattement : 152 500 €.
Base taxable : 310 000 − 152 500 = **157 500 €**.
Taxation à 20 % (le seuil des 700 000 € n'étant pas atteint) : **31 500 €** par enfant.
...
Page **Cockpit stratégique** · articles **B6** (clause bénéficiaire) et **D7** (après 70 ans).
...
- L'absence de la mention **« vivants ou représentés »** peut exclure tes petits-enfants.
- Une clause **non mise à jour** après un divorce ou un remariage produit des effets que personne n'avait voulus.
...
Page **Cockpit stratégique** · articles **B5** (succession) et **D5** (étapes d'une succession).
...
- Les **frais internes des unités de compte** s'ajoutent aux frais du contrat et sont déjà déduits de la performance affichée.
- Depuis 2022, les assureurs doivent publier un **tableau standardisé** des frais : c'est le document à réclamer.
...
**4. Les frais internes des unités de compte.** Ce sont les frais du fonds lui-même, entre 0,2 % pour un ETF et 2 % pour un fonds actions géré activement. Ils **n'apparaissent pas sur ton relevé d'assurance-vie**, parce qu'ils sont déjà déduits de la valeur liquidative du fonds. C'est la couche invisible, et souvent la plus lourde après les frais de gestion.

### Où les lire concrètement

Ton relevé annuel doit mentionner le montant des frais prélevés en euros. Cherche les lignes « frais de gestion » et « frais sur versement ».

Pour les frais internes, il faut aller voir le **document d'informations clés** de chaque unité de compte, qui affiche les coûts récurrents.

Depuis juin 2022, chaque assureur publie sur son site un **tableau standardisé des frais** de ses contrats, dans un format comparable d'un acteur à l'autre. C'est le document le plus utile de tout ce sujet, et presque personne ne le consulte.

### Ce que les frais coûtent, chiffré

**Exemple.** Sonia place 50 000 € pendant vingt ans, sur un support dont on retient une hypothèse de performance brute de 5 % par an.

*Contrat A, 0,6 % de frais de gestion et unités de compte à 0,25 %.* Coût total annuel : 0,85 %. Capital au terme : environ **112 400 €**.

*Contrat B, 1 % de frais de gestion et unités de compte à 1,8 %.* Coût total annuel : 2,8 %. Capital au terme : environ **77 900 €**.

L'écart atteint **34 500 €**, sur le même versement, la même durée et la même performance brute. Rien dans cet écart ne dépend des marchés : il est entièrement contractuel, et connu d'avance.

Précision nécessaire : 5 % n'est pas un rendement garanti, c'est une hypothèse de calcul destinée à isoler l'effet des frais. Un support en unités de compte peut perdre de la valeur.

### Ce qui justifie des frais plus élevés, et ce qui ne le justifie pas
...
Les frais sur versement le sont souvent, les frais de gestion rarement.

**Peut-on transférer son contrat sans perdre l'antériorité ?**
Depuis la loi Pacte, un transfert est possible **au sein du même assureur**, en conservant l'antériorité fiscale. Vers un autre assureur, cela reste impossible.
...
Code des assurances, article L. 522-5 sur l'information précontractuelle · Engagement de place du 2 février 2022 sur la transparence des frais, France Assureurs et AFG · Loi Pacte du 22 mai 2019, article 72 sur la transférabilité · AMF et ACPR, recommandations sur l'information des épargnants.

### Liens internes

Page **Tarifs** · articles **E4** (frais sur vingt ans) et **B4** (fonds euros ou UC).
...
- L'arbitrage dépend d'un seul paramètre dominant : **l'écart entre ta tranche marginale aujourd'hui et celle que tu auras à la retraite**.
- Point 2026 : les prélèvements sociaux sur le PER ont suivi la hausse à 18,6 %, quand l'assurance-vie reste à 17,2 %.
...
Page **Cockpit stratégique** · articles **C2** (PER) et **B1** (fiscalité de l'assurance-vie).
