...
faq:
  - q: "Le statut non-dom dure-t-il vraiment dix-sept ans ?"
    r: "Il s'éteint lorsque la personne est réputée avoir acquis un domicile chypriote, au terme d'un nombre d'années de résidence apprécié sur une période de référence. C'est la durée la plus longue d'Europe, mais elle est bornée : un projet de très long terme doit anticiper l'après."
  - q: "Les dividendes sont-ils totalement exonérés ?"
    r: "Ils échappent à l'impôt sur le revenu pour un résident non domicilié. Des contributions locales peuvent néanmoins s'appliquer aux revenus de capitaux, dont une contribution au financement du système de santé, généralement plafonnée. Intégrez-les au calcul net."
  - q: "Qu'apporte concrètement l'appartenance à l'Union européenne ?"
    r: "Quatre choses, sans rien à démontrer au-delà de la résidence : le sursis automatique d'exit tax, la dispense de représentant fiscal accrédité, un régime de sanction allégé sur les comptes étrangers et la coordination santé. Pour un dirigeant au-dessus du seuil d'exit tax, cela pèse davantage que deux points d'imposition."
  - q: "Mes loyers français seront-ils couverts par le statut non-dom ?"
    r: "Non. Ils restent imposables en France, où le bien est situé. Chypre imposant les revenus mondiaux de ses résidents, la convention organise l'élimination de la double imposition, mais la poche française reste soumise aux règles françaises."
  - q: "Faut-il passer un nombre de jours minimum à Chypre ?"
    r: "Oui. La résidence chypriote se constate chaque année selon des critères de présence sur l'île, et le maintien du statut de non-domicilié suppose de les remplir sans interruption. Ce n'est pas un statut acquis une fois pour toutes : il se vérifie année après année. Tenez un relevé de vos jours de présence, comme vous le feriez pour n'importe quelle règle de résidence, car la preuve vous incombera. Et rappelez-vous que remplir le critère chypriote ne suffit pas à vous rendre non-résident français : les quatre critères de l'article 4 B s'apprécient séparément."
pages:
