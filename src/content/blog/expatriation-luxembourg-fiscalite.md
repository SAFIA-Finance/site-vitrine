...
faq:
  - q: "Un contrat luxembourgeois est-il moins imposé qu'un contrat français ?"
    r: "Non. Sa fiscalité est celle de votre pays de résidence. Son intérêt tient à la protection de l'épargnant, à sa portabilité en cas de mobilité internationale et à son ouverture aux non-résidents, pas à un traitement fiscal plus doux."
  - q: "Puis-je transférer mon contrat français vers le Luxembourg ?"
    r: "Non, il n'existe pas de transfert conservant l'antériorité fiscale. Il faut racheter le contrat français, en acquittant la fiscalité du rachat, puis souscrire un nouveau contrat. Le calcul doit donc comparer le coût immédiat du rachat à l'avantage attendu."
  - q: "Le Luxembourg a-t-il un régime spécial pour les nouveaux résidents ?"
    r: "Non. Contrairement à l'Italie, au Portugal ou à la Grèce, il n'existe pas de régime dérogatoire d'attraction. L'intérêt du pays tient à la structure de sa fiscalité mobilière et à son écosystème financier, pas à un statut temporaire."
  - q: "Le coût de la vie est-il un obstacle ?"
    r: "Le logement figure parmi les plus chers d'Europe, à l'achat comme à la location. Pour un retraité sans avantage fiscal dérogatoire, ce paramètre suffit souvent à écarter la destination."
  - q: "Faut-il souscrire un contrat luxembourgeois pour s'expatrier ?"
    r: "Non, ce n'est ni une condition ni une nécessité. C'est un outil, pertinent dans un cas précis : celui d'une personne qui changera de pays plusieurs fois et qui veut éviter de racheter puis resouscrire à chaque mobilité, avec la perte d'antériorité que cela suppose. Pour une expatriation unique et durable vers un pays de l'Union européenne, conserver un bon contrat français, dont les prélèvements sociaux cessent d'être dus une fois non-résident, est souvent la solution la plus simple et la moins coûteuse. Comparez le coût immédiat du rachat à l'avantage réellement attendu avant de transférer quoi que ce soit."
pages:
