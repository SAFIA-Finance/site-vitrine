...
faq:
  - q: "Les revenus étrangers non rapatriés sont-ils vraiment exonérés ?"
    r: "Pour un résident non domicilié, ils sont en principe hors du champ de l'impôt maltais tant qu'ils ne sont pas reçus à Malte, sous réserve de l'impôt minimum annuel applicable dans le cadre des programmes de résidence. L'exonération suppose une traçabilité rigoureuse des flux."
  - q: "Que se passe-t-il si je mélange capital et revenus sur un même compte ?"
    r: "Vous créez un compte mixte, et l'administration peut considérer que les sommes rapatriées proviennent en priorité de la fraction imposable. C'est l'erreur la plus coûteuse du régime, et elle se prévient par une séparation des comptes dès l'installation."
  - q: "Les plus-values sont-elles imposées ?"
    r: "Les plus-values de source étrangère ne sont en principe pas imposées à Malte, y compris lorsqu'elles sont rapatriées. C'est la particularité la plus favorable du système pour un dirigeant après cession."
  - q: "Le régime est-il stable ?"
    r: "Les programmes de résidence maltais ont fait l'objet d'un examen attentif au niveau européen et leurs conditions évoluent. Comme pour toute destination reposant sur un statut dérogatoire, l'hypothèse d'une modification doit être intégrée à un projet de long terme."
  - q: "Peut-on vivre à Malte sans rien rapatrier ?"
    r: "Non, et c'est la limite pratique du régime. Vivre suppose de payer un loyer, des courses et des factures sur place, donc de faire entrer des fonds. La question n'est pas d'éviter tout rapatriement mais de **choisir ce que vous rapatriez** : organiser les flux pour faire venir en priorité du capital constitué avant l'installation, plutôt que des revenus courants postérieurs. C'est précisément pour cela que la séparation des comptes doit être en place dès le premier jour."
  - q: "Malte convient-elle à un retraité ?"
    r: "Elle peut convenir, et un programme dédié existe avec ses conditions propres. Deux avantages pèsent : la coordination européenne de sécurité sociale, qui permet la prise en charge des soins, et l'appartenance à l'Union, qui dispense de toute démarche d'exit tax. Le calcul doit intégrer l'impôt minimum annuel, le coût du logement et l'insularité, qui pèse sur les trajets comme sur l'accès aux soins spécialisés."
pages:
