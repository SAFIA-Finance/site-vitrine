...
faq:
  - q: "Peut-on changer d'avis après la liquidation ?"
    r: "Non. La conversion en rente est irréversible."
  - q: "La sortie en capital est-elle possible sur tous les PER ?"
    r: "Sur les versements volontaires et l'épargne salariale, oui. Certains compartiments issus de versements obligatoires imposent la rente."
  - q: "Y a-t-il un âge maximal pour liquider ?"
    r: "Non, et différer la liquidation peut avoir un intérêt fiscal si tes autres revenus baissent ensuite."
  - q: "Peut-on sortir une partie en capital et continuer à verser ?"
    r: "Oui. Une liquidation totale ferme le plan, mais une sortie partielle en capital le laisse ouvert, et les versements restent possibles, avec la déduction correspondante si tu es encore imposable. C'est un intérêt du fractionnement rarement mis en avant : il ne referme pas la porte. Depuis la loi de finances pour 2026, la déductibilité s'arrête toutefois à 70 ans."
pages:
