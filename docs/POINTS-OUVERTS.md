...
| — | Page ADN investisseur | **Refaite le 23/09/2026**, validée par Maxime. Elle ne parlait que d'ESG et de convictions, ce qui la rendait incohérente avec le schéma du cockpit. Elle présente désormais les **trois piliers** en trois cartes, dans l'ordre du schéma : finance traditionnelle, finance à impact, finance comportementale, cette dernière étiquetée **fonctionnalité à venir**. Un garde-fou explicite rappelle que **l'ADN n'est pas le profil de risque** et que le profil réglementaire filtre en premier. Ajout d'un bloc « la boucle » en quatre temps, et de trois questions à la FAQ. **Écart corrigé au passage** : la FAQ existe à deux endroits, le tableau des données structurées et les blocs dépliants ; seul le premier avait été complété, ce qui aurait déclaré 9 questions à Google pour 6 affichées | `/adn-investisseur/` |
| — | Page marketplace | **Créée le 23/09/2026**, validée par Maxime. Adressée aux **producteurs**, rangée dans le menu Professionnels à côté de Conseillers et Institutions. Titre court voulu par Maxime : « Distribuer un produit sur SAFIA ». Deux garde-fous tiennent la page : l'étiquette **fonctionnalité à venir** dès le hero avec une section sur l'état d'avancement, et une section **« Ce que nous ne faisons pas »** qui déclare l'absence de rétrocession et de mise en avant payante. Les six partenaires nommés ont donné leur accord ; **ELVEST n'y figure pas**, faute de confirmation. Le contact renvoie vers `/conseillers/#contact`, le formulaire des pages professionnelles, par choix de Maxime : une demande de producteur arrivera donc avec `/conseillers/` comme page d'origine | `/marketplace/` |
| — | Blog, vérification des fiches destination | **Fait le 23/09/2026.** Les **23 fiches** (I7 à I26, K5 à K7) ont été relevées puis confrontées aux sources officielles : GOV.UK, Agenzia delle Entrate, portail des finances portugais, Agencia Tributaria, SPF Finances, administration luxembourgeoise, MonServicePublic monégasque, Revenue irlandaise, IRAS, Agence du revenu du Canada, IRS, MRA mauricienne, Revenue Department thaïlandais, autorité fiscale émirienne, BOFiP pour l'exit tax. **Aucune erreur n'a été trouvée.** Six enrichissements ont été apportés, décidés par Maxime : ajout de la condition portugaise de cinq ans et de la retenue de 35 % ; franchise belge portable à 15 000 € ; Fair Share Contribution mauricienne ; investissement andorran porté à 800 000 € ; extension familiale italienne précisée selon la date de transfert. **Un faux positif corrigé en cours de route** : j'avais recommandé de retirer la ligne maltaise annonçant de nouveaux seuils au 01/01/2027, faute de l'avoir trouvée à une source officielle. Elle est fondée : le **Legal Notice 195 of 2026**, *Individual Tax Programme Rules, 2026*, est publié à la *Government Gazette* n° 21 686 du 14 juillet 2026. La ligne a été rétablie et le lien vers le recueil législatif maltais ajouté aux sources. Le relevé complet est sur le Bureau de Maxime | Territoires I et K |
| — | K8, date de fermeture du Girardin | **Vérifié le 23/09/2026 : K8 avait raison.** La page d'impots.gouv.fr sur les avantages fiscaux dans les DOM écrit que la réduction s'applique « jusqu'au 31 décembre 2029 [...] selon les dispositions de l'article 199 undecies B », avec une exclusion pour les entreprises réalisant au moins dix millions d'euros de chiffre d'affaires dans les DROM. La réserve inscrite dans l'article **L6 est donc levée** : il porte maintenant la date, la condition de chiffre d'affaires et le lien vers la source | Articles K8 et L6 |
| — | Blog, dispositifs fiscaux | **Fait le 22/09/2026.** Territoire **L, « Dispositifs fiscaux »**, douzième catégorie du blog : neuf articles, de 1 279 à 1 864 mots, tous au-dessus du seuil de 1 200. Malraux, monuments historiques, Denormandie, Loc'Avantages, Relance logement (Jeanbrun), Girardin industriel, capital-investissement, SOFICA, groupements forestiers et viticoles. **Chaque chiffre est vérifié à une source officielle**, BOFiP ou service-public, et chaque source est un lien réel. Trois découvertes ont changé le plan en cours de route : les **FCPI et FIP classiques ont été supprimés en 2026** (la pastille du schéma, devenue fausse, est corrigée en « Capital-investissement et FIP outre-mer »), le **statut du bailleur privé existe** sous le nom de Relance logement jusqu'au 31/12/2028, et **le BOFiP est accessible** alors que Légifrance répond 403. Exclus car fermés : Pinel (31/12/2024), Censi-Bouvard, Cosse | Territoire L, `/blog/categorie/dispositifs-fiscaux/` |
| — | Calendly dans les politiques | **Réglé le 21/09/2026, vérifié en production.** Calendly traite des données pour le compte de SAFIA et ne figurait ni parmi les sous-traitants de l'article 9, ni dans les durées de l'article 11. Les deux mentions sont ajoutées à la source, c'est-à-dire au `.docx` : « Calendly, LLC pour la prise de rendez-vous depuis le site internet » et « Demandes de rendez-vous prises depuis le site internet (nom, adresse email, créneau) : jusqu'au rendez-vous, puis 12 mois ». Entité et durée choisies par Maxime. L'original est sauvegardé dans `reference/pages-legales/originaux-2026-09-21/`. Rien n'était à ajouter à la politique de **cookies** : le bloc de `/fondateur/` est un **lien sortant**, sans cookie ni script tiers sur `safia.finance`. **Ne pas intégrer le calendrier dans la page sans rouvrir ce point** : le widget contactait treize domaines tiers, dont Stripe, Google reCAPTCHA et OneTrust, et affichait son propre bandeau de consentement sous celui du site | `reference/pages-legales/` |
| — | Citation d'origine collée au bloc violet | **Corrigé le 21/09/2026**, validé par Maxime. `section.origine-bloc` était en `padding-top:0`, volontairement, pour que la citation arrive vite après le hero. Mais le bloc précédent est violet : à zéro, le filet dégradé de la citation démarrait pile sur la frontière de couleur et la touchait, et la citation lisait comme un texte orphelin collé au bord. 72 px sur ordinateur, 56 px sur mobile, mesurés sur le rendu. Rien d'autre ne bouge. `/fondateur/` n'est pas concernée, elle utilise le bloc `.histoire` | `src/styles/global.css` |
