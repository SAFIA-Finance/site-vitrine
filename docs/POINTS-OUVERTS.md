...
| **Page ADN investisseur, à refaire entièrement** | Décidé par Maxime le 22/09/2026. Le schéma de la marketplace (`/cockpit/`) présente désormais l'ADN investisseur sur **trois piliers** : finance traditionnelle (stratégie financière et patrimoniale), finance à impact (secteurs, convictions, ESG) et finance comportementale (réactions face au risque et aux pertes). Au-dessus, deux profils filtrent en premier : le **profil réglementaire** et le **profil fiscal**. La page `/adn-investisseur/`, elle, ne parle encore que d'ESG et de convictions : elle est donc incohérente avec le schéma tant qu'elle n'est pas refaite. La finance comportementale est une fonctionnalité **à venir**, à présenter comme telle. |
| **Page marketplace, pour les partenaires** | Validée dans son principe par Maxime le 22/09/2026 : une page dédiée dans le menu « Professionnels », à côté de Conseillers et Institutions, pour attirer les producteurs. Trois règles. La marketplace est **à venir**, la page ne doit jamais laisser croire qu'elle est ouverte. Les partenaires affichés sur `/cockpit/` (Trail Finance, Silex, 6AM, PEQAN, PAMS, CMF) ont **donné leur accord**. **ELVEST n'est pas confirmé** : ne pas l'afficher avant. Plan et rendu à montrer à Maxime avant construction. |
